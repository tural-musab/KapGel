  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-orange-50 via-white to-red-50">
      <AppHeader
        rightSlot={
          <>
            <HeaderButton href="/">Ana Sayfa</HeaderButton>
            <SignOutButton />
          </>
        }
      />
...
function HeaderButton({ href, children }: { href: string; children: ReactNode }) {
  return (
    <Link
      href={href}
...
function SignOutButton({ label = 'Çıkış Yap' }: { label?: string }) {
  return (
