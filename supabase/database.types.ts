  ...
  public: {
    Tables: {
      ...
      courier_applications: {
        ...
        Relationships: [
          {
            foreignKeyName: "courier_applications_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: true
      ...
      logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "logs_courier_id_fkey"
            columns: ["courier_id"]
            isOneToOne: false
            referencedRelation: "couriers"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "logs_vendor_id_fkey"
            columns: ["vendor_id"]
            isOneToOne: false
            referencedRelation: "vendors"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      create_order_with_items: {
        Args: { items_input: Json; order_input: Json }
        Returns: Json
      }
      delete_old_logs: {
        Args: Record<PropertyKey, never>
