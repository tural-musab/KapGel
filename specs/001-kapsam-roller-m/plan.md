...
- **Auth UX Backlog**: Kayıt deneyimi güncellendi. Müşteriler e-posta doğrulamasından sonra doğrudan platforma erişebilmeli; işletme olmak isteyen kullanıcılar ek bir “vendor başvuru” formu doldurup admin onayını beklemeli. Phase 3.3 altında yeni görevler: T047 (vendor başvuru formu), T048 (admin onay e-postası ve vendor aktivasyonu), T049 (vendor başvuru durum sayfası). Kurye self-signup devre dışı kalacak; vendor paneline temel “kurye ekle” akışı eklenmeli.
